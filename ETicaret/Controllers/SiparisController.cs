...
namespace ETicaret.Controllers
{
    public class SiparisController : Controller
    {
        ...
        public ActionResult SiparisTamamla()
        {
            ...
            string ClientId = "1003050"; // Bankanın bize verdiği kod 
            ...
            string Instalment = "";
            string HasStr =ClientId+sipId+ToplamTutar+onayURL+hataURL+TransActionType+Instalment+RDN+StoreKey; // Bankanın istediği bilgiler bunlar .

            System.Security.Cryptography.SHA1 sha = new System.Security.Cryptography.SHA1CryptoServiceProvider();

            byte[] HashBytes = System.Text.Encoding.GetEncoding("ISO-8859-9").GetBytes(HasStr);
